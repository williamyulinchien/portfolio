export const projects = [
  {
    title: 'MERN BNB',
    description: "Using React, Node.js, Express and MongoDB to build a Full Stack MERN Application. The App is a BNB-like website that allows users to post their properties to reserve other's.",
  ...
  {
    title: 'Car Showcase',
    description:"Using NextJS 13 app router with API integrations to demonstrate different scenario of cars. This application implements search and filter functionalities in client-side rendering.  ",
